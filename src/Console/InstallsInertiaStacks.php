...
trait InstallsInertiaStacks
{
    ...
    protected function installInertiaVueStack()
    {
        ...
        if (!$this->option('dark')) {
            $this->removeDarkClasses((new Finder)->in(resource_path('js'))->name('*.vue')->notName('welcome.vue'));
        }
        ...
        copy(__DIR__ . '/../../stubs/inertia-vue-ts/vite.config.ts', base_path('vite.config.js'));
